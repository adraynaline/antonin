...
<header>		
	<span id="menu" ><a class="second"><img  width="130px" src="images/logo/logomenu.png"></a></span>
	<p id="logo"><a href="?appli=home&action=home"><img width="200px" src="images/logo/logofiinal.png"></a></p>	
	<div class="clear"></div>
</header>
<div id="modal" style="display:none">
	<nav>
	   	<?php foreach($other_modele as $other): ?>
	   		<a href="?appli=home&action=home&modele=<?php echo $other['id']; ?>">
	    		<div class="menu_item">
		   			<p class="nom_modele"><?php echo $other['nom']; ?></p>
		   			<center><img src="<?php echo $other['min_img']; ?>"></center>
		   			<br/>
	   			</div>
	   		</a>
		<?php endforeach; ?>
